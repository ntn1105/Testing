<?php
    ...
    if(Helper::is_submit('addcat')){
        $category = new Category();
        $category->setName(Helper::input_value('ten'));
        if(!empty($category) && CategoryDB::addCategory($category)){
      ...
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <form id="addCat" action="" method="post" enctype="multipart/form-data">
            ...
            <input class="btn-sm btn-dark" type="submit"  value="Thêm danh mục">
          <a class="btn btn-cancel" href="<?php echo Helper::get_url('admin/?c=listcat');?>">Hủy bỏ</a>
        </div>
            </form>
  </main>
