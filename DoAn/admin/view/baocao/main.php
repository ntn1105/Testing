      ...
      <div class="col-md-12">
        <div class="app-title">
          <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><a href="#"><b>Báo cáo  </b></a></li>
          </ul>
          <div id="clock"></div>
        </div>
      </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="widget-small primary coloured-icon"><i class='icon  bx bxs-user fa-3x'></i>
                    <div class="info">
                        ...
                        <?php if($user1->getKieu()==2) $nguoidung++;?>
                         <?php endforeach; ?>
                         <b> <?php echo "".$nguoidung;?>Khách hàng</b></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="widget-small info coloured-icon"><i class='icon bx bxs-purchase-tag-alt fa-3x' ></i>
                    <div class="info">
                        ...
                        <?php endforeach; ?>      
                                <b><?php echo "".$sanpham;?> Sản Phẩm</b></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                        ...
                        <?php 
                          $thunhap=0;
                           if(!empty($chitiets))
                             ...
                             if(!empty($products))
                                foreach ($products as $product):?>
                            <?php if( $chitiet->getIdsp()==$product->getId()) $thunhap+=$chitiet->getSoluong()*$product->getGia(); ?>
                            <?php endforeach; ?>

                          <?php endforeach; ?>
                            <b><?php echo "".$thunhap;?> đ</b></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                    ...
                    <div class="info">
                        ...
                        <p> <?php 
                          $danhmuc=0;
                           ...
                           <b><?php echo  "".$danhmuc; ?> Danh Mục</b></p>
                    </div>
                </div>
            </div>
                ...
                <div class="widget-small danger coloured-icon"><i class='icon fa-3x bx bxs-info-circle' ></i>
                    <div class="info">
                        ...
                        <?php 
                          ...
                          if(!empty($users))
                         foreach ($users as $user1):?>
                           <?php if($user1->getKieu()==1) $nguoidung++;?>
                          <?php endforeach; ?>
                          <b> <?php echo "".$nguoidung;?>Nhân Viên</b></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="info">
                        ...
                        <p><?php 
                             $chuathanhtoan=0;
                              if(!empty($donhangs))
                                foreach ($donhangs as $donhang):?>
                                <?php if($donhang->getIdttdh()==1) $chuathanhtoan++;?>
                             <?php endforeach; ?>    
                                <b><?php echo "".$chuathanhtoan;?> Đơn Hàng</b></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                    ...
                    <div class="info">
                        ...
                        <p><?php 
                             $dathanhtoan=0;
                              if(!empty($donhangs))
                                foreach ($donhangs as $donhang):?>
                                <?php if($donhang->getIdttdh()==2) $dathanhtoan++;?>
                             <?php endforeach; ?>    
                                <b><?php echo "".$dathanhtoan;?> Đơn Hàng</b></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                    ...
                    <div class="info">
                        ...
                        <p><?php 
                             $chuaxuly=0;
                              if(!empty($donhangs))
                                foreach ($donhangs as $donhang):?>
                                <?php if($donhang->getNgayxuly()==1) $chuaxuly++;?>
                             <?php endforeach; ?>    
                                <b><?php echo "".$chuaxuly;?> Đơn Hàng</b></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-3">
                <div class="widget-small warning coloured-icon"><i class='icon fa-3x bx bxs-tag-x' ></i>
                    <div class="info">
                        ...
                        $sanphamhet=0;
                             if(!empty($products))
                                foreach ($products as $product) : ?>
                                <?php if($product->getNoibat()==0) $sanphamhet++;?>

                        <?php endforeach; ?>      
                                <b><?php echo "".$sanphamhet;?> Sản Phẩm</b></p>
                    </div>
                </div>
            </div>
