   ...
   $products = ProductDB::findProducts($search);
                          ...
                          <div class="table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $product->getGiachinh();?></td>
                                    <td><?php echo $product->getNoibat(); ?>
                                      ...
                                      //        {  echo $product->getNoibat()-$chitiet->getSoluong().'';}
                                             ?>   
                                              <?php //endforeach; ?></td>
                                    <td><span class="badge bg-success"><?php if( $product->getNoibat()!=0) {echo 'Còn Hàng';} else {echo 'Hết Hàng';} ?></span></td>
...
if(Helper::is_submit('deletepro')){
        ...
        if(!empty($products) && ProductDB::deleteProduct($products)){
          ...
          Helper::redirect(Helper::get_url('admin/?c=findpro'));
        }
        else{
